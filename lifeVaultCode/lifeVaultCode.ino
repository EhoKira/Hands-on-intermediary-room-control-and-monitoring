...
String authorizedTags[] = { "b31c5510", "dpo9xcd9" };
...
void loop() {
  ...
  String postData = "{\"temperatura\": " + String(temperatura, 2) + " \"ºC\", \"umidade\": " + String(umidade, 2) + "%}";
  String message;
  if(temperatura > 32){
